        ...
        <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
          ...
          <div className='flex flex-col'>
            <div className='flex items-center space-x-4 md:space-x-8'>
                <input value={cat} onChange={(e)=>setCat(e.target.value)} className='px-4 py-2 ' placeholder='Enter post category' type="text"/>
          ...
          <textarea onChange={(e)=>setDesc(e.target.value)} value={desc} rows={15} cols={30} className='px-4 py-2' placeholder='Enter post description'/>
