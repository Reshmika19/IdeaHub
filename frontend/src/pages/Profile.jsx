    ...
    <div>
      ...
      <div className="min-h-[80vh] px-8 md:px-[200px] mt-8 flex md:flex-row flex-col-reverse md:items-start items-start">
        ...
        <h1 className="text-xl font-bold mb-4">Profile</h1>
          <input onChange={(e)=>setUsername(e.target.value)} value={username} className=" px-4 py-2 text-gray-500" placeholder="Your username" type="text"/>
          <input onChange={(e)=>setEmail(e.target.value)} value={email} className=" px-4 py-2 text-gray-500" placeholder="Your email" type="email"/>
